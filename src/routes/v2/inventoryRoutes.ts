...
router.put("/settings", validate(updateInventorySettingsSchema), (req, res) =>
  controller.updateSettings(req, res),
);
router.patch("/settings", validate(updateInventorySettingsSchema), (req, res) =>
  controller.updateSettings(req, res),
);

router.get("/:id", (req, res) => controller.getById(req, res));
router.post("/", validate(createInventorySchema), (req, res) =>
  controller.create(req, res),
);
router.put("/:id", validate(updateInventorySchema), (req, res) =>
  controller.update(req, res),
);
router.delete("/:id", (req, res) => controller.remove(req, res));
router.post("/:id/consume", validate(consumeInventorySchema), (req, res) =>
