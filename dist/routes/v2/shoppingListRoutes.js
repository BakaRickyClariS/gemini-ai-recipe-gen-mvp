...
router.delete("/shopping-lists/:id", jwtAuth, (req, res) => controller.delete(req, res));
// Items in a list
router.get("/shopping-lists/:id/items", jwtAuth, (req, res) => controller.getItems(req, res));
router.post("/shopping-lists/:id/items", jwtAuth, validate(createShoppingListItemSchema), (req, res) => controller.createItem(req, res));
// Item by ID
router.put("/shopping-list-items/:itemId", jwtAuth, validate(updateShoppingListItemSchema), (req, res) => controller.updateItem(req, res));
router.delete("/shopping-list-items/:itemId", jwtAuth, (req, res) => controller.deleteItem(req, res));
