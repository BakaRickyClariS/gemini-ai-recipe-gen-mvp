...
router.put("/:id", jwtAuth, validate(updateGroupSchema), (req, res) => controller.update(req, res));
router.delete("/:id", jwtAuth, (req, res) => controller.delete(req, res));
// Invitations
router.post("/:id/invitations", jwtAuth, (req, res) => controller.createInvitation(req, res));
router.post("/join", jwtAuth, validate(joinGroupSchema), (req, res) => controller.join(req, res));
// Members
router.delete("/:id/members/:memberId", jwtAuth, (req, res) => controller.removeMember(req, res));
