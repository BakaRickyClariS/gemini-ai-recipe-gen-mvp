...
async function listTables() {
    ...
    `);
        ...
        const refTable = result.rows.find((r) => r.table_name.includes("refrigerator"));
        if (refTable) {
        ...
        const linkTable = result.rows.find((r) => r.table_name.includes("user") && r.table_name.includes("refrigerator"));
        if (linkTable) {
        ...
        const memberTable = result.rows.find((r) => r.table_name.includes("member"));
        if (memberTable) {
