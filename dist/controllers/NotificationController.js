...
export class NotificationController extends BaseController {
    ...
    async getNotifications(req, res) {
        try {
            ...
            const result = await notificationService.getNotifications(userId, page, limit, category, "v2");
    ...
    async send(req, res) {
        try {
            ...
            if (groupId) {
                await notificationService.sendToRefrigeratorMembers(groupId, title, body, type, action, category, operatorId, subType, actorName, groupName);
                this.handleSuccess(res, {
            ...
            this.handleError(new Error("Either userIds or groupId must be provided"), res, "Notification.send");
        }
        catch (error) {
