...
export class V1CronController extends BaseController {
    ...
    validateCronSecret(req, res, next) {
    ...
    async checkExpiry(_req, res) {
      ...
      `;
            ...
            for (const [fridgeId, items] of Object.entries(itemsByRefrigerator)) {
                ...
                await notificationService.sendToRefrigeratorMembers(fridgeId, "食材即將過期提醒", `${itemNames}${moreCount} 即將過期，請儘快使用！`, "inventory", { type: "inventory", payload: { refrigeratorId: fridgeId } }, "stock", undefined, "stock", "System");
                notificationsSent++;
            }
