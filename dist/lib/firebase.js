...
if (!serviceAccount) {
    try {
        ...
        console.warn("⚠️ [Firebase] No service account found. Push notifications will be disabled.");
    }
}
...
export const messaging = admin.apps.length
    ...
    : {
        ...
        send: async () => {
            console.warn("⚠️ [Firebase] Mock send called because initialization failed. Check your FIREBASE_SERVICE_ACCOUNT_KEY.");
            return "mock-id";
        },
    };
